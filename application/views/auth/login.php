            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form action="<?php echo base_url().'login-auth'?>" class="md-float-material" method="POST" enctype="multipart/form-data">
                            <div class="text-center">
                                <img src="<?php echo base_url().'assets/images/shoplogo1.png'?>" alt="logo.png" width="120px">
                            </div>
                            <div class="auth-box">
                           ...
                           ?>
                                ...
                                <div class="input-group">
                                    <input type="email" class="form-control" name="username" placeholder="Your Email Address">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <img src="<?php echo base_url().'assets/images/shoplogo1.png'?>" alt="small-logo.png" width="50px">
                                    </div>
                                </div>
