...
<thead>
    ...
    <tr>
        ...
        <td class="text-center"><?= $products->pro_name;?></td>
        ...
        ?>
       <td align="center" id="changeaction2<?= $products->id ?>">
...

   {
...

    {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('manage-product/map_product'); ?>",
...

   {
...

    {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('manage-product/remove_map_product'); ?>",
