                ...
                <?php } ?>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="start_date" id="start_date" min="<?= date('Y-m-d'); ?>" class="form-control" onchange="validate_date()" value="<?= $value->start_date; ?>" >
                                    <div id="msg"></div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="expiry_date" id="expiry_date" min="<?= date('Y-m-d'); ?>" class="form-control" onchange="validate_date()"  value="<?= $value->expiry_date; ?>">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
